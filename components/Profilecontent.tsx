...
function Profilecontent() {
    return (
        <div className='col-span-8 lg:col-span-5 border-x-2 border-gray-100'>
            ...
            <div className='flex mr-3 pr-3'>
                <div className="relative">
                    ...
                    <div className="absolute bottom-0 left-8 ...">
                        <img src='images/default-img.jpg' className=' border-slate-50 border-4 flex h-24 w-24 rounded-full' />
                    </div>
            ...
            <div className='flex justify-between mt-4 transition-all duration-1000 ease-out '>
                <p className=' hover:bg-slate-200 p-6'>Tweets</p>
                <p className=' hover:bg-slate-200 p-6'>Tweets & Replies</p>
                <p className=' hover:bg-slate-200 p-6'>Media</p>
                <p className=' hover:bg-slate-200 p-6'>Likes</p>
            </div>
